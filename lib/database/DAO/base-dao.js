...
var BaseDao = {
    getAll: function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(collection, obj, schema) {
            var db;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            ...
                            obj = obj && obj._id ? _extends({}, obj, {
                                _id: new ObjectId(obj._id)
                            }) : obj;
                            return _context.abrupt("return", new Promise(function (resolve, reject) {
                                db.collection(collection).find(obj || {}, schema || {}).toArray(function (err, result) {
                                    if (err) {
                                        reject(err);
                                    } else {
                                        resolve(result);
    ...
    create: function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(collection, obj) {
            var db;
                                    ...
                                    return regeneratorRuntime.wrap(function _callee4$(_context4) {
                                        while (1) {
                                            switch (_context4.prev = _context4.next) {
                                                case 0:
                                                    db.collection(collection).insertOne(_extends({}, obj), function (err, res) {
                                                        if (err) {
                                                            reject(err);
                                                        } else {
    ...
    updateById: function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(collection, obj) {
            var storedObj, o;
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 11:
                            return _context6.abrupt("return", BaseDao.getBy(collection, o._id));
        ...
        return function updateById(_x12, _x13) {
            return _ref6.apply(this, arguments);
        };
    }(),
    removeById: function () {
        var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(collection, _id) {
            var db;
        ...
        return function removeById(_x14, _x15) {
